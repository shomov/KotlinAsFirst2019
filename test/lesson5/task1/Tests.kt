...
class Tests {
    ...
    fun containsIn() {
        ...
        assertFalse(containsIn(mapOf("a" to "z", "b" to "sweet"), mapOf("a" to "z", "b" to "sfeet")))
...
//        assertTrue(canBuildFrom(listOf('B'), "BB"))
    ...
    fun bagPacking() {
        assertEquals(
            setOf("Слиток"),
            bagPacking(
                mapOf("Кубок" to (500 to 2000), "Слиток" to (700 to 5000)),
                850
            )
        )
        assertEquals(
